            ...
            <div class="col-md-9 col-lg-10">
                ...
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-header bg-white pt-4 pb-3 border-bottom">
                        <h4 class="mb-0 fw-bold" style="color: var(--primary-gov);"><i class="fa-solid fa-pen-to-square me-2"></i>Edit Scholarship Scheme</h4>
                    </div>
                    <div class="card-body p-4">
                        <?php if($error): ?><div class="alert alert-danger shadow-sm border-0 rounded-4 mb-4"><?php echo $error; ?></div><?php endif; ?>
                        <?php if($success): ?><div class="alert alert-success shadow-sm border-0 rounded-4 mb-4"><?php echo $success; ?></div><?php endif; ?>

                        <form method="POST" action="">
                            <div class="row g-3">
                                <div class="col-md-8">
                                    <label class="form-label small fw-bold text-uppercase text-muted">Scheme Title <span class="text-danger">*</span></label>
                                    <input type="text" name="title" class="form-control bg-white rounded-3" value="<?php echo htmlspecialchars($sch['title'] ?? ''); ?>" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label small fw-bold text-uppercase text-muted">Scheme Type</label>
                                    <select name="scheme_type" class="form-select bg-white rounded-3">
                                ...
                                <div class="col-12">
                                    <label class="form-label small fw-bold text-uppercase text-muted">Short Description</label>
                                    <textarea name="short_description" class="form-control bg-white rounded-3" rows="2"><?php echo htmlspecialchars($sch['short_description'] ?? ''); ?></textarea>
                                </div>

                                <div class="col-12">
                                    <label class="form-label small fw-bold text-uppercase text-muted">Benefits & Financial Assistance</label>
                                    <textarea name="benefits" class="form-control bg-white rounded-3" rows="3"><?php echo htmlspecialchars($sch['benefits'] ?? ''); ?></textarea>
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label small fw-bold text-uppercase text-muted">Application Start Date <span class="text-danger">*</span></label>
                                    <input type="date" name="start_date" class="form-control bg-white rounded-3" value="<?php echo htmlspecialchars($sch['start_date'] ?? ''); ?>" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label small fw-bold text-uppercase text-muted">Application Deadline <span class="text-danger">*</span></label>
                                    <input type="date" name="deadline" class="form-control bg-white rounded-3" value="<?php echo htmlspecialchars($sch['deadline'] ?? ''); ?>" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label small fw-bold text-uppercase text-muted">Status</label>
                                    <select name="status" class="form-select bg-white rounded-3">
                                ...
                                <div class="col-12 mt-4">
                                    <button type="submit" class="btn btn-dark btn-lg w-100 fw-bold shadow-sm rounded-pill py-3">
